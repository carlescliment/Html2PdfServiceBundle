...
class FunctionalTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'html2pdf.curl' => 'getHtml2pdf_CurlService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return carlescliment\Html2PdfServiceBundle\Bridge\CurlHtml2PdfBridge A carlescliment\Html2PdfServiceBundle\Bridge\CurlHtml2PdfBridge instance.
     */
    protected function getHtml2pdf_BridgeService()
    {
        return $this->services['html2pdf.bridge'] = new \carlescliment\Html2PdfServiceBundle\Bridge\CurlHtml2PdfBridge($this->get('html2pdf.curl'), 'localhost', 8082);
    }

    /**
     * Gets the 'html2pdf.curl' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getHtml2pdf_CurlService()
    {
        return $this->services['html2pdf.curl'] = new \carlescliment\Html2PdfServiceBundle\Bridge\CurlWrapper();
    }
