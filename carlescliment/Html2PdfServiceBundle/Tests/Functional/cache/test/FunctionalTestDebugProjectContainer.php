...
/**
 * FunctionalTestDebugProjectContainer
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class FunctionalTestDebugProjectContainer extends Container
{
    /**
     * Constructor.
     */
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'html2pdf.bridge' => 'getHtml2pdf_BridgeService',
            'html2pdf.curl_wrapper' => 'getHtml2pdf_CurlWrapperService',
            'html2pdf.fopen_wrapper' => 'getHtml2pdf_FopenWrapperService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test/annotations', true);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/Resources');
    }
    ...
    /**
     * Gets the 'html2pdf.bridge' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return carlescliment\Html2PdfServiceBundle\Bridge\SimpleHtml2PdfBridge A carlescliment\Html2PdfServiceBundle\Bridge\SimpleHtml2PdfBridge instance.
     */
    protected function getHtml2pdf_BridgeService()
    {
        return $this->services['html2pdf.bridge'] = new \carlescliment\Html2PdfServiceBundle\Bridge\SimpleHtml2PdfBridge($this->get('html2pdf.fopen_wrapper'), 'localhost', 8082);
    }

    /**
     * Gets the 'html2pdf.curl_wrapper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return carlescliment\Html2PdfServiceBundle\Bridge\CurlWrapper A carlescliment\Html2PdfServiceBundle\Bridge\CurlWrapper instance.
     */
    protected function getHtml2pdf_CurlWrapperService()
    {
        return $this->services['html2pdf.curl_wrapper'] = new \carlescliment\Html2PdfServiceBundle\Bridge\CurlWrapper();
    }

    /**
     * Gets the 'html2pdf.fopen_wrapper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return carlescliment\Html2PdfServiceBundle\Bridge\FileOpenWrapper A carlescliment\Html2PdfServiceBundle\Bridge\FileOpenWrapper instance.
     */
    protected function getHtml2pdf_FopenWrapperService()
    {
        return $this->services['html2pdf.fopen_wrapper'] = new \carlescliment\Html2PdfServiceBundle\Bridge\FileOpenWrapper();
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test/profiler', '', '', 86400), NULL);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/routing.yml', array('cache_dir' => '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'FunctionalTestUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'FunctionalTestUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test/translations', 'debug' => true));
    }
    ...
    {
        return $this->services['validator'] = new \Symfony\Component\Validator\Validator($this->get('validator.mapping.class_metadata_factory'), new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array()), $this->get('translator.default'), 'validators', array());
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 1 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/Html2PdfServiceBundle/vendor/symfony/form/Symfony/Component/Form/Resources/config/validation.xml')), 2 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'Functional',
            'kernel.cache_dir' => '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test',
            'kernel.logs_dir' => '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/logs',
            'kernel.bundles' => array(
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
                'carlesclimentHtml2PdfServiceBundle' => 'carlescliment\\Html2PdfServiceBundle\\carlesclimentHtml2PdfServiceBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'FunctionalTestDebugProjectContainer',
            ...
            'debug.container.dump' => '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test/FunctionalTestDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/Html2PdfServiceBundle/vendor/symfony/form/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/cache/test/profiler',
            ...
            'router.options.matcher.cache_class' => 'FunctionalTestUrlMatcher',
            'router.options.generator.cache_class' => 'FunctionalTestUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => '/var/www/Html2PdfServiceBundle/carlescliment/Html2PdfServiceBundle/Tests/Functional/routing.yml',
            'router.cache_class_prefix' => 'FunctionalTest',
