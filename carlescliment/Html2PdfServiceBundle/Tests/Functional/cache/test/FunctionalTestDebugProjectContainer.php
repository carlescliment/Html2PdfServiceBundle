...
class FunctionalTestDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return carlescliment\Html2PdfServiceBundle\Bridge\Html2PdfBridge A carlescliment\Html2PdfServiceBundle\Bridge\Html2PdfBridge instance.
     */
    protected function getHtml2pdf_BridgeService()
    {
        return $this->services['html2pdf.bridge'] = new \carlescliment\Html2PdfServiceBundle\Bridge\Html2PdfBridge($this->get('html2pdf.curl'), 'localhost', 8082);
    }
